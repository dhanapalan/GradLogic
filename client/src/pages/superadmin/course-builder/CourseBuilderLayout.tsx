// =============================================================================
// Course Builder — shared layout (Learning Hub)
// Assembles Knowledge Library assets into placement-prep courses.
// =============================================================================
...
const TABS = [
  ...
  { name: "Draft", href: `${BASE}/draft` },
  { name: "Published", href: `${BASE}/published` },
  { name: "Archived", href: `${BASE}/archived` },
  { name: "AI Builder", href: `${BASE}/ai` },
  { name: "Templates", href: `${BASE}/templates` },
          ...
          <div className="flex flex-wrap items-start justify-between gap-3 mb-4">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500 max-w-2xl">
                Assemble reusable Knowledge Library assets into structured placement-preparation
                courses — do not create lessons here.
              </p>
            </div>
            <Link
              to={`${BASE}/new`}
